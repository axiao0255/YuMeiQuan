...
- (void)initSubviews
{
    ...
    BOOL is_iphone6_or_6p = NO;
    if ( IS_IPHONE_6 || IS_IPHONE_6P ) {
        is_iphone6_or_6p = YES;
    }
    
    // 个人用户
    UIImageView *personalImageView = [[UIImageView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH/2-82+24, is_iphone6_or_6p?30:16, 164, 164)];
    ...
    personalButton.frame = CGRectMake(SCREEN_WIDTH/2-70, is_iphone6_or_6p?150:132, 140, 34);
    ...
    UIImageView *companyImageView = [[UIImageView alloc] initWithFrame:CGRectMake(CGRectGetMinX(personalImageView.frame),
                                                                                 CGRectGetMaxY(personalButton.frame) + (is_iphone6_or_6p?30:16),
                                                                                  164, 164)];
    ...
    companyButton.frame = CGRectMake(CGRectGetMinX(personalButton.frame),
                                     is_iphone6_or_6p?336:298, 140, 34);
...
////    [aboutUs sizeToFit];
    ...
    UIImageView *aboutUsView = [[UIImageView alloc] initWithFrame:CGRectMake(0, VIEW_HEIGHT-148, SCREEN_WIDTH, 148)];
    if ( IS_IPHONE_4_OR_LESS ) {
        aboutUsView.frame = CGRectMake(0, 380, SCREEN_WIDTH, 148);
    }
    aboutUsView.image = [UIImage imageNamed:@"ic_inviteVIewBottom.png"];
