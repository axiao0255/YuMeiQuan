...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if ( self ) {
        self.contentLabel = [[UILabel alloc] initWithFrame:CGRectMake(20, 0, SCREEN_WIDTH - 30 - 50, 40)];
        self.contentLabel.font = [UIFont systemFontOfSize:16];
        self.contentLabel.backgroundColor = [UIColor clearColor];
        self.contentLabel.textColor = [Utils getRGBColor:70.0 g:70.0 b:70.0 a:1.0];
        [self.contentView addSubview:self.contentLabel];
        
        self.arrowImageView = [[UIImageView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH - 20 - 16, 12, 16, 16)];
