...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if ( self ) {
        ...
        self.icoImageView = [[UIImageView alloc] initWithFrame:CGRectMake(240, 49, icoImage.size.width, icoImage.size.height)];
        ...
        self.tallyLabel = [[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH - 15 - 80, 48, 80, 20)];
        ...
        self.tallyLabel.font = [UIFont systemFontOfSize:10];
